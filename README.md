...
![Live proxies](https://img.shields.io/badge/live%20proxies-565-22c55e?style=flat-square)
...
![Updated](https://img.shields.io/badge/updated-04%20Sep%202026%2005%3A50%20UTC-64748b?style=flat-square)
...
Right now you get **565 working proxies** in **67 countries**. Half of
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 565 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 565 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 565 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 282 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 159 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 124 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 257 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 257 of our proxies
...
The average proxy in this list has **83.7% uptime**. So if you load 100
...
You get 565 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-04 05:50 UTC. This page and every file are generated
