...
![Median speed](https://img.shields.io/badge/median%20speed-1,154%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2018%3A45%20UTC-64748b?style=flat-square)
...
Right now you get **433 working proxies** in **57 countries**. Half of
them answer in under **1,154 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 152 | Your tool asks for an HTTP proxy. Start here |
...
| [`protocol/https/https.txt`](protocol/https/https.txt) | 170 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 350 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 170 of our proxies
...
**Last updated:** 2026-09-22 18:45 UTC. This page and every file are generated
