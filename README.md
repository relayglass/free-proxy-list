...
![Median speed](https://img.shields.io/badge/median%20speed-1,135%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2015%3A45%20UTC-64748b?style=flat-square)
...
Right now you get **451 working proxies** in **59 countries**. Half of
them answer in under **1,135 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 150 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 126 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 175 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 190 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 376 | The site must not see that you use a proxy |
...
The average proxy in this list has **84.7% uptime**. So if you load 100
addresses from `all.txt` and try them all at once, expect about **85** to answer.
...
**Last updated:** 2026-09-22 15:45 UTC. This page and every file are generated
