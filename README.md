...
![Median speed](https://img.shields.io/badge/median%20speed-871%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-04%20Sep%202026%2022%3A35%20UTC-64748b?style=flat-square)
...
Right now you get **501 working proxies** in **58 countries**. Half of
them answer in under **871 ms**.
...
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 137 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 110 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 197 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 382 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 197 of our proxies
...
**Last updated:** 2026-09-04 22:35 UTC. This page and every file are generated
