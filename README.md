...
![Live proxies](https://img.shields.io/badge/live%20proxies-429-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-61-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-1,209%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2014%3A10%20UTC-64748b?style=flat-square)
...
Right now you get **429 working proxies** in **61 countries**. Half of
them answer in under **1,209 ms**.
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 429 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 429 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 429 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 125 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 125 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 179 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 166 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 166 of our proxies
...
You get 429 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-22 14:10 UTC. This page and every file are generated
