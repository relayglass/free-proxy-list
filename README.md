...
![Live proxies](https://img.shields.io/badge/live%20proxies-495-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-60-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-899%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-05%20Sep%202026%2018%3A55%20UTC-64748b?style=flat-square)
...
Right now you get **495 working proxies** in **60 countries**. Half of
them answer in under **899 ms**.
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 495 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 495 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 495 | Your code would rather not parse CSV |
...
You get 495 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-05 18:55 UTC. This page and every file are generated
