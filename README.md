...
![Median speed](https://img.shields.io/badge/median%20speed-837%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-21%20Sep%202026%2009%3A35%20UTC-64748b?style=flat-square)
...
Right now you get **651 working proxies** in **66 countries**. Half of
them answer in under **837 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 318 | Your tool asks for an HTTP proxy. Start here |
...
| [`protocol/https/https.txt`](protocol/https/https.txt) | 368 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 535 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 368 of our proxies
...
**Last updated:** 2026-09-21 09:35 UTC. This page and every file are generated
