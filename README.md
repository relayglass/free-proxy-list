...
![Live proxies](https://img.shields.io/badge/live%20proxies-439-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-67-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-1,080%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2016%3A35%20UTC-64748b?style=flat-square)
...
Right now you get **439 working proxies** in **67 countries**. Half of
them answer in under **1,080 ms**.
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 439 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 439 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 439 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 142 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 114 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 183 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 179 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 367 | The site must not see that you use a proxy |
...
countries/
  ...
  ...one folder per country, 67 right now
...
You get 439 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-22 16:35 UTC. This page and every file are generated
