...
![Median speed](https://img.shields.io/badge/median%20speed-915%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-23%20Aug%202026%2018%3A15%20UTC-64748b?style=flat-square)
...
Right now you get **368 working proxies** in **46 countries**. Half of
them answer in under **915 ms**.
...
| [`anonymity/elite/`](anonymity/elite) | 294 | The site must not see that you use a proxy |
...
The average proxy in this list has **94.1% uptime**. So if you load 100
addresses from `all.txt` and try them all at once, expect about **94** to answer.
...
**Last updated:** 2026-08-23 18:15 UTC. This page and every file are generated
