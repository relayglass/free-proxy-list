...
![Median speed](https://img.shields.io/badge/median%20speed-1,074%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2018%3A20%20UTC-64748b?style=flat-square)
...
Right now you get **438 working proxies** in **57 countries**. Half of
them answer in under **1,074 ms**.
...
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 168 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 186 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 346 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 186 of our proxies
...
The average proxy in this list has **84% uptime**. So if you load 100
...
**Last updated:** 2026-09-22 18:20 UTC. This page and every file are generated
