...
![Median speed](https://img.shields.io/badge/median%20speed-1,265%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-11%20Aug%202026%2016%3A20%20UTC-64748b?style=flat-square)
...
Right now you get **546 working proxies** in **54 countries**. Half of
them answer in under **1,265 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 271 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 138 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 137 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 246 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 412 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 246 of our proxies
...
**Last updated:** 2026-08-11 16:20 UTC. This page and every file are generated
