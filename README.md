...
![Live proxies](https://img.shields.io/badge/live%20proxies-786-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-83-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-865%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-21%20Sep%202026%2005%3A00%20UTC-64748b?style=flat-square)
...
Right now you get **786 working proxies** in **83 countries**. Half of
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 786 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 786 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 786 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 368 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 159 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 259 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 438 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 438 of our proxies
...
countries/
  ...
  ...one folder per country, 83 right now
...
The average proxy in this list has **73.7% uptime**. So if you load 100
...
You get 786 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-21 05:00 UTC. This page and every file are generated
