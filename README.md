...
![Median speed](https://img.shields.io/badge/median%20speed-1,151%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2019%3A30%20UTC-64748b?style=flat-square)
...
Right now you get **431 working proxies** in **58 countries**. Half of
them answer in under **1,151 ms**.
...
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 156 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 172 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 354 | The site must not see that you use a proxy |
...
The average proxy in this list has **87.1% uptime**. So if you load 100
...
**Last updated:** 2026-09-22 19:30 UTC. This page and every file are generated
