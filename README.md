...
![Updated](https://img.shields.io/badge/updated-07%20Aug%202026%2016%3A25%20UTC-64748b?style=flat-square)
...
Right now you get **492 working proxies** in **58 countries**. Half of
...
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 142 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 230 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 387 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 230 of our proxies
...
The average proxy in this list has **87.8% uptime**. So if you load 100
...
**Last updated:** 2026-08-07 16:25 UTC. This page and every file are generated
