...
![Live proxies](https://img.shields.io/badge/live%20proxies-392-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-47-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-1,016%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-24%20Aug%202026%2016%3A30%20UTC-64748b?style=flat-square)
...
Right now you get **392 working proxies** in **47 countries**. Half of
them answer in under **1,016 ms**.
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 392 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 392 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 392 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 183 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 104 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 105 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 147 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 147 of our proxies
...
The average proxy in this list has **92.9% uptime**. So if you load 100
...
You get 392 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-08-24 16:30 UTC. This page and every file are generated
