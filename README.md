...
![Countries](https://img.shields.io/badge/countries-48-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-1,012%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-24%20Aug%202026%2016%3A45%20UTC-64748b?style=flat-square)
...
Right now you get **395 working proxies** in **48 countries**. Half of
them answer in under **1,012 ms**.
...
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 109 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 103 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 153 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 300 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 153 of our proxies
...
countries/
  ...
  ...one folder per country, 48 right now
...
The average proxy in this list has **91.5% uptime**. So if you load 100
...
**Last updated:** 2026-08-24 16:45 UTC. This page and every file are generated
