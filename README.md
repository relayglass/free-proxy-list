...
![Median speed](https://img.shields.io/badge/median%20speed-1,021%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-30%20Aug%202026%2007%3A15%20UTC-64748b?style=flat-square)
...
Right now you get **540 working proxies** in **57 countries**. Half of
them answer in under **1,021 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 260 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 183 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 97 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 233 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 441 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 233 of our proxies
...
**Last updated:** 2026-08-30 07:15 UTC. This page and every file are generated
