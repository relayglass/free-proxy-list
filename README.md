...
![Median speed](https://img.shields.io/badge/median%20speed-1,101%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-30%20Aug%202026%2005%3A45%20UTC-64748b?style=flat-square)
...
Right now you get **613 working proxies** in **58 countries**. Half of
them answer in under **1,101 ms**.
...
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 288 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 96 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 332 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 332 of our proxies
...
**Last updated:** 2026-08-30 05:45 UTC. This page and every file are generated
