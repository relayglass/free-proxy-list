...
![Median speed](https://img.shields.io/badge/median%20speed-1,115%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-30%20Aug%202026%2004%3A55%20UTC-64748b?style=flat-square)
...
Right now you get **649 working proxies** in **54 countries**. Half of
them answer in under **1,115 ms**.
...
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 304 | You need SOCKS5, which also carries non-web traffic |
...
| [`anonymity/elite/`](anonymity/elite) | 560 | The site must not see that you use a proxy |
...
**Last updated:** 2026-08-30 04:55 UTC. This page and every file are generated
