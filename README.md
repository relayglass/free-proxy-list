...
![Median speed](https://img.shields.io/badge/median%20speed-1,132%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2018%3A30%20UTC-64748b?style=flat-square)
...
Right now you get **423 working proxies** in **57 countries**. Half of
them answer in under **1,132 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 138 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 112 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 173 | Your tool only speaks the older SOCKS4 |
...
The average proxy in this list has **86.7% uptime**. So if you load 100
...
**Last updated:** 2026-09-22 18:30 UTC. This page and every file are generated
