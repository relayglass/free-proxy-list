...
![Live proxies](https://img.shields.io/badge/live%20proxies-485-22c55e?style=flat-square)
...
![Updated](https://img.shields.io/badge/updated-04%20Sep%202026%2021%3A20%20UTC-64748b?style=flat-square)
...
Right now you get **485 working proxies** in **60 countries**. Half of
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 485 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 485 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 485 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 248 | Your tool asks for an HTTP proxy. Start here |
...
The average proxy in this list has **88% uptime**. So if you load 100
...
You get 485 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-04 21:20 UTC. This page and every file are generated
