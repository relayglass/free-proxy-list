...
![Updated](https://img.shields.io/badge/updated-25%20Aug%202026%2017%3A10%20UTC-64748b?style=flat-square)
...
| [`protocol/https/https.txt`](protocol/https/https.txt) | 121 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 292 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 121 of our proxies
...
The average proxy in this list has **93.4% uptime**. So if you load 100
...
**Last updated:** 2026-08-25 17:10 UTC. This page and every file are generated
