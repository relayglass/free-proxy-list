...
![Live proxies](https://img.shields.io/badge/live%20proxies-442-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-61-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-1,131%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2015%3A35%20UTC-64748b?style=flat-square)
...
Right now you get **442 working proxies** in **61 countries**. Half of
them answer in under **1,131 ms**.
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 442 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 442 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 442 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 145 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 123 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 174 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 187 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 369 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 187 of our proxies
...
The average proxy in this list has **85.8% uptime**. So if you load 100
...
You get 442 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-22 15:35 UTC. This page and every file are generated
