...
![Live proxies](https://img.shields.io/badge/live%20proxies-553-22c55e?style=flat-square)
![Countries](https://img.shields.io/badge/countries-68-3b82f6?style=flat-square)
![Median speed](https://img.shields.io/badge/median%20speed-910%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-04%20Sep%202026%2005%3A55%20UTC-64748b?style=flat-square)
...
Right now you get **553 working proxies** in **68 countries**. Half of
...
| --- | ---: | --- |
| [`all.txt`](all.txt) | 553 | You want everything, `ip:port` on each line |
| [`all.csv`](all.csv) | 553 | You want to filter by country, speed, or uptime |
| [`all.json`](all.json) | 553 | Your code would rather not parse CSV |
| [`protocol/http/http.txt`](protocol/http/http.txt) | 271 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 158 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 124 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 251 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 251 of our proxies
...
countries/
  ...
  ...one folder per country, 68 right now
...
The average proxy in this list has **83.6% uptime**. So if you load 100
...
You get 553 working proxies, updated every 5 minutes. Check the `anonymity` column
...
**Last updated:** 2026-09-04 05:55 UTC. This page and every file are generated
