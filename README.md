...
![Median speed](https://img.shields.io/badge/median%20speed-1,181%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2019%3A25%20UTC-64748b?style=flat-square)
...
Right now you get **430 working proxies** in **59 countries**. Half of
them answer in under **1,181 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 153 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 119 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 158 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 168 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 360 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 168 of our proxies
...
**Last updated:** 2026-09-22 19:25 UTC. This page and every file are generated
