...
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2007%3A10%20UTC-64748b?style=flat-square)
...
Right now you get **526 working proxies** in **65 countries**. Half of
...
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 215 | Your tool only speaks the older SOCKS4 |
...
The average proxy in this list has **79.3% uptime**. So if you load 100
addresses from `all.txt` and try them all at once, expect about **79** to answer.
...
**Last updated:** 2026-09-22 07:10 UTC. This page and every file are generated
