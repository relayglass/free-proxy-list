...
![Median speed](https://img.shields.io/badge/median%20speed-931%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-04%20Sep%202026%2003%3A05%20UTC-64748b?style=flat-square)
...
Right now you get **514 working proxies** in **60 countries**. Half of
them answer in under **931 ms**.
...
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 149 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 110 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 226 | You need to load `https://` pages through the proxy |
...
`https://` page needs a different trick, called CONNECT, and only 226 of our proxies
...
**Last updated:** 2026-09-04 03:05 UTC. This page and every file are generated
