...
![Median speed](https://img.shields.io/badge/median%20speed-948%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-31%20Aug%202026%2007%3A45%20UTC-64748b?style=flat-square)
...
Right now you get **564 working proxies** in **59 countries**. Half of
them answer in under **948 ms**.
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 287 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 174 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 103 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 264 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 446 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 264 of our proxies
...
The average proxy in this list has **84.4% uptime**. So if you load 100
...
**Last updated:** 2026-08-31 07:45 UTC. This page and every file are generated
