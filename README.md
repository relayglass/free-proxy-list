...
![Updated](https://img.shields.io/badge/updated-13%20Sep%202026%2012%3A35%20UTC-64748b?style=flat-square)
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 199 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 100 | You need SOCKS5, which also carries non-web traffic |
...
| [`anonymity/elite/`](anonymity/elite) | 333 | The site must not see that you use a proxy |
...
The average proxy in this list has **85.7% uptime**. So if you load 100
...
**Last updated:** 2026-09-13 12:35 UTC. This page and every file are generated
