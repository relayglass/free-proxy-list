...
![Updated](https://img.shields.io/badge/updated-27%20Aug%202026%2006%3A20%20UTC-64748b?style=flat-square)
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 227 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 110 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 87 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 182 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 316 | The site must not see that you use a proxy |
...
**Last updated:** 2026-08-27 06:20 UTC. This page and every file are generated
