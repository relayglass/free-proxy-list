...
![Median speed](https://img.shields.io/badge/median%20speed-1,164%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2019%3A15%20UTC-64748b?style=flat-square)
...
Right now you get **434 working proxies** in **57 countries**. Half of
them answer in under **1,164 ms**.
...
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 164 | Your tool only speaks the older SOCKS4 |
...
The average proxy in this list has **86.8% uptime**. So if you load 100
...
**Last updated:** 2026-09-22 19:15 UTC. This page and every file are generated
