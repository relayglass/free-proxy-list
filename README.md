...
![Median speed](https://img.shields.io/badge/median%20speed-1,437%20ms-a855f7?style=flat-square)
![Updated](https://img.shields.io/badge/updated-22%20Sep%202026%2013%3A55%20UTC-64748b?style=flat-square)
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 144 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 121 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 165 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 167 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 358 | The site must not see that you use a proxy |
...
The average proxy in this list has **86.4% uptime**. So if you load 100
...
**Last updated:** 2026-09-22 13:55 UTC. This page and every file are generated
