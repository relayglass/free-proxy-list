...
![Updated](https://img.shields.io/badge/updated-10%20Sep%202026%2022%3A10%20UTC-64748b?style=flat-square)
...
Right now you get **424 working proxies** in **54 countries**. Half of
...
| [`protocol/http/http.txt`](protocol/http/http.txt) | 203 | Your tool asks for an HTTP proxy. Start here |
| [`protocol/socks5/socks5.txt`](protocol/socks5/socks5.txt) | 101 | You need SOCKS5, which also carries non-web traffic |
| [`protocol/socks4/socks4.txt`](protocol/socks4/socks4.txt) | 120 | Your tool only speaks the older SOCKS4 |
| [`protocol/https/https.txt`](protocol/https/https.txt) | 130 | You need to load `https://` pages through the proxy |
| [`anonymity/elite/`](anonymity/elite) | 319 | The site must not see that you use a proxy |

A note on the HTTPS file. Many HTTP proxies can only forward plain `http://` pages. Loading an
`https://` page needs a different trick, called CONNECT, and only 130 of our proxies
...
The average proxy in this list has **88.1% uptime**. So if you load 100
...
**Last updated:** 2026-09-10 22:10 UTC. This page and every file are generated
